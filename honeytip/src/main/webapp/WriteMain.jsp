...
<head>
    ...
    <link href="css/WriteMain_style.css" rel="stylesheet" type="text/css" />
</head>
<body>
...
<div class="container">
 ...
 <br><br>
    ...
    <Section>
    <div>보고싶은 태그를 선택해주세요</div>
    
    <select onchange="window.open(value,'_blank');"  style="width:100px;height:30px;">
